// JavaScript version of _b.coffee
...
window._b = {
  ...
  numDelimiter: '.',
  numPresicion: 2,
  currencyDefaults: {'separator': ',', 'delimiter': '.', 'precision': 2},
  ...
  getExtnameImage: function(file) {
    ...
    switch (ext.toLowerCase()) {
      case "pdf":
        return "/assets/programs/pdf.png";
      case "xls":
      case "xlsx":
      case "xlsm":
        return "/assets/programs/excel.png";
      case "doc":
      case "docx":
        return "/assets/programs/word.png";
      case "html":
      case "htm":
        return "/assets/programs/html.png";
      case "pps":
      case "ppt":
      case "pptx":
        return "/assets/programs/powerpoint.png";
      case "psd":
        return "/assets/programs/photoshop.png";
      default:
        return "/assets/programs/file.png";
    }
  },

  currencyLabel: function(val) {
    if (val != null && window.currencies && window.currencies[val]) {
      return ['<span class="label bg-black" title=',
        '"', window.currencies[val]['name'], '"', ' data-toggle="tooltip">',
        val, '</span>'].join('');
    }
    return '';
  },
